...
void Jungle::Fase::FlorestaBranca::criarMapa(){
    ...
    criarPlataforma(sf::Vector2f(1200.0f, 400.0f));
    criarPlataforma(sf::Vector2f(1100.0f, 250.0f));
    criarCaixa(sf::Vector2f(400.0f, 500.0f));
    criarCaixa(sf::Vector2f(1000.0f, 350.0f));
}
